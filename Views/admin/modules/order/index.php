...
<main>
    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
        <div x-data="{ pageName: `Quản lý đơn hàng` }">
        ...
        <div class="space-y-5 sm:space-y-6">
                                ...
                                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                                    <?php foreach ($orders as $order): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="admin.php?page=orders&action=edit&id=<?= $order['id'] ?>"
                                                    ...
                                                    Xem chi tiết <i class="bi bi-pencil-square"></i>
            ...
            <div class="w-full flex flex-col items-center justify-center mt-6 mb-4">
                <div class="mb-2 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    đến 
                    <span class="font-semibold text-brand-600 dark:text-brand-400"><?= min($pagination['currentPage'] * $pagination['limit'], $pagination['totalOrders']) ?></span> 
                    trên tổng số 
                    <span class="font-semibold text-brand-600 dark:text-brand-400"><?= $pagination['totalOrders'] ?></span> đơn hàng.
                </div>
                <nav class="flex flex-wrap gap-1 justify-center items-center" aria-label="Pagination">
                    <!-- Previous -->
                    <a href="?page=orders&action=index&page_num=<?= $pagination['currentPage'] - 1 ?>"
                    ...
                    <?php for ($i = 1; $i <= $pagination['totalPages']; $i++): ?>
                        <a href="?page=orders&action=index&page_num=<?= $i ?>"
