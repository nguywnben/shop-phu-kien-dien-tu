    ...
    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
                                    ...
                                    <?php foreach ($brands as $brand): ?>
                                        <tr>
                                            ...
                                            <td class="px-5 py-4 sm:px-6">
                                                <div class="flex items-center">
                                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                        <img src="../../../../Assets/client/img/<?= $brand['logo'] ?>" alt="logo" class="w-16 h-16 object-contain">
                                                    </p>
                                                </div>
                                            </td>
                                            <td class="px-5 py-4 sm:px-6">
        ...
        <div class="w-full flex flex-col items-center justify-center mt-6 mb-4">
            <div class="mb-2 text-sm text-gray-500 dark:text-gray-400">
                ...
                đến 
                <span class="font-semibold text-brand-600 dark:text-brand-400"><?= min($pagination['currentPage'] * $pagination['limit'], $pagination['totalBrands']) ?></span> 
                trên tổng số 
                <span class="font-semibold text-brand-600 dark:text-brand-400"><?= $pagination['totalBrands'] ?></span> thương hiệu.
            </div>
            <nav class="flex flex-wrap gap-1 justify-center items-center" aria-label="Pagination">
                ...
                <?php for ($i = 1; $i <= $pagination['totalPages']; $i++): ?>
                    <a href="?page=brands&action=index&page_num=<?= $i ?>"
