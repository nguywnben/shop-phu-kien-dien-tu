...
<main>
    <div class="p-4 mx-auto max-w-(--breakpoint-2xl) md:p-6">
        <div x-data="{ pageName: `Quản lý Bài viết`}">
        ...
        <div class="space-y-5 sm:space-y-6">
                                    ...
                                    <?php foreach ($posts as $post): ?>
                                        <tr>
                                            ...
                                            <td class="px-5 py-4 sm:px-6">
                                                <div class="flex items-center">
                                                    <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                                        <img src="<?= $post['cover_image'] ?>" alt="logo"
                                            ...
                                            <td>
                                                <a href="admin.php?page=posts&action=edit&id=<?= $post['id'] ?>"
                                                ...
                                                <form method="post" action="admin.php?page=posts&action=delete"
            ...
            <div class="w-full flex flex-col items-center justify-center mt-6 mb-4">
                <div class="mb-2 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    đến 
                    <span class="font-semibold text-brand-600 dark:text-brand-400"><?= min($pagination['currentPage'] * $pagination['limit'], $pagination['totalPosts']) ?></span> 
                    trên tổng số 
                    <span class="font-semibold text-brand-600 dark:text-brand-400"><?= $pagination['totalPosts'] ?></span> bài viết.
                </div>
                <nav class="flex flex-wrap gap-1 justify-center items-center" aria-label="Pagination">
                    <!-- Previous -->
                    <a href="?page=posts&action=index&page_num=<?= $pagination['currentPage'] - 1 ?>"
                    ...
                    <?php for ($i = 1; $i <= $pagination['totalPages']; $i++): ?>
                        <a href="?page=posts&action=index&page_num=<?= $i ?>"
