            ...
            if (isset($pagination) && $pagination['totalPages'] > 1):
                ...
                <div class="w-full flex flex-col items-center justify-center mt-6 mb-4">
                    <div class="mb-2 text-sm text-gray-500 dark:text-gray-400">
                        Hiển thị
                    <span class="font-semibold text-brand-600 dark:text-brand-400"><?= $pagination['totalProducts'] - ($pagination['currentPage'] - 1) * $pagination['limit'] ?></span>
                        đến
                    <span class="font-semibold text-brand-600 dark:text-brand-400"><?= max($pagination['totalProducts'] - $pagination['currentPage'] * $pagination['limit'] + 1, 1) ?></span>
                       trên tổng số
