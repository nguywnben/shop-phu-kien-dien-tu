            ...
            <div class="hidden lg:block">
                <form>
                    <div class="relative">
                        ...
                        <input type="text" placeholder="Tìm kiếm hoặc nhập lệnh..." id="search-input"
            ...
            <div class="relative" x-data="{ dropdownOpen: false }" @click.outside="dropdownOpen = false">
                <a class="flex items-center text-gray-700 dark:text-gray-400" href="#"
                    ...
                    <span class="text-theme-sm mr-1 block font-medium">
                        <?php echo isset($_SESSION['login']['name']) ? htmlspecialchars($_SESSION['login']['name']) : 'User'; ?>
                    </span>
                ...
                <div x-show="dropdownOpen"
                    ...
                    <div>
                        ...
                        <span class="text-theme-xs mt-0.5 block text-gray-500 dark:text-gray-400">
                            <?php echo isset($_SESSION['login']['email']) ? htmlspecialchars($_SESSION['login']['email']) : ''; ?>
                        </span>
                    </div>

                    <ul class="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3 dark:border-gray-800">
                        <li>
                            <a href="?page=profile&action=index"
