...
if (!isset($formattedUsers)) $formattedUsers = number_format(0); 
if (!isset($formattedOrders)) $formattedOrders = number_format(0);
?>
            <main>
                            ...
                            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
                                ...
                                <div class="col-span-1 sm:col-span-1">
                                    <div
                                        ...
                                        <div class="flex h-16 w-16 items-center justify-center rounded-xl bg-gray-100 dark:bg-gray-800">
                                            <svg class="fill-gray-800 dark:fill-white/90" width="32" height="32" viewBox="0 0 24 24" fill="none"
